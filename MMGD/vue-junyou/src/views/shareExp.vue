...
<template>
  <!-- 回上一頁 -->
  <img src="@/img/back.png" className="sh-back" title="back" alt="this is back" @click="goHomePage" />
  <div class="sh-middle">
    <!-- 搜尋框 -->
    <input type="text" placeholder="請輸入職業" class="sh-searchBox" v-model="searchContent" />
    <!-- 搜尋框查詢按鈕 -->
    <img src="@/img/magnifying-glass.png" title="searchBoxGlass" alt="this is searchBoxGlass" class="sh-searchBoxGlass"
      @click="reloadApi" />
  </div>
