...
const modeifyPwd = async () => {
  const api = `http://172.20.10.3:8000/modeifyPwd`;
  await axios
    .post(api, {
...
<template>
  ...
  <img src="@/img/back.png" className="np-back" title="back" alt="this is back" @click="goLogin" />
  <div class="npPage">
      <img src="@/img/logo_75.jpg" alt="this is logo" class="np-logo" @click="goHomePage" />
